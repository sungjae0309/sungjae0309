...
| **[whyblockchain](https://github.com/sungjae0309/whyblockchain)** | "왜 블록체인이어야 하는가" 일반인이 이해를 돕는 사이트(개발중) | `TypeScript` |
...
`TypeScript` `JavaScript` `Python` &nbsp;|&nbsp; `React` `Tailwind CSS` `Zustand` &nbsp;|&nbsp;  `Figma`
